    ...
    <div className="absolute inset-x-0 z-20 mx-0 flex h-auto justify-center lg:hidden ">
      <nav className="sm:6/12 h-auto w-10/12 rounded-lg bg-neutral-dark-violet pb-4 transition-all">
        ...
        <div className="flex flex-col px-4 font-mono text-lg font-semibold">
          <button className="my-2 mx-4 block h-11 w-auto rounded-full font-semibold text-white" title="login">
            Login
          </button>
          <button className="my-2 mx-4 block h-11 w-auto rounded-full bg-primary-cyan font-semibold text-white transition duration-500 ease-in-out hover:bg-opacity-20" title="register">
            Sign Up
          </button>
        </div>
      </nav>
