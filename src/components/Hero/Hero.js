...
const Hero = () => {
  return (
    <div className="container flex flex-col-reverse items-center lg:flex-row pb-36 px-6 bg-white md:pt-12 xl:px-0">
      <div className="w-full flex flex-col items-center px-2 mt-12 lg:mt-0 lg:px-0 lg:items-start">
        ...
        <button className="bg-primary-cyan my-6 px-9 py-3 rounded-full text-white font-bold">Get Started</button>
      </div>
      <div className = "sm:w-full h-full overflow-hidden md:self-end">
        <img src={Illustration} alt="illustration" className="relative w-screen -right-28 sm:-right-56 lg:-right-8 lg:h-auto overflow-hidden" />
      </div>
    </div>
  );
};
